        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null && mAuth.getCurrentUser().isEmailVerified()){
                    ...
                    Toast.makeText(CustomerLoginActivity.this, "Welcome to HOUSEandHOMES", Toast.LENGTH_SHORT).show();
                    startActivity(intent);
                    finish();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            ...
                            if(mAuth.getCurrentUser().isEmailVerified()){
                                ...
                                DatabaseReference current_user_db = FirebaseDatabase.getInstance("https://medrescue-2f1ab-default-rtdb.firebaseio.com").getReference().child("Users").child("Customers").child(user_id);
