        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null && mAuth.getCurrentUser().isEmailVerified()){
                    ...
                    Toast.makeText(DriverLoginActivity.this, "Welcome to HOUSEandHOMES", Toast.LENGTH_SHORT).show();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(!task.isSuccessful()){
                            ...
                            if(mAuth.getCurrentUser().isEmailVerified()){
                                ...
                                DatabaseReference current_user_db = FirebaseDatabase.getInstance("https://medrescue-2f1ab-default-rtdb.firebaseio.com").getReference().child("Users").child("Drivers").child(user_id);
